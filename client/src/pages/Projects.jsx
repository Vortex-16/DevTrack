            ...
            >
                <div className="flex items-start gap-3 md:gap-4">
                    ...
                    <div className="min-w-0 flex flex-col justify-center min-h-[3rem]">
                        ...
                        <p className="text-slate-400 text-xs md:text-sm leading-tight line-clamp-2">{label}</p>
                    </div>
                </div>
            </div>
        </motion.div>
...
function ProjectCard({
    ...
    const progress =
        project.status === 'Completed' ? 100 : (project.aiAnalysis?.progressPercentage ?? project.progress ?? 0);
                ...
                <div className="flex items-start justify-between mb-4">
                    <div className="flex-1 min-w-0" onClick={onToggle} style={{ cursor: 'pointer' }}>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <motion.span animate={{ rotate: isExpanded ? 180 : 0 }} className="text-slate-500 text-xs">
                                <ChevronDown className="w-4 h-4 ml-1 opacity-50" />
                            </motion.span>
                        </div>
                        <p className={`text-slate-400 text-sm ${isExpanded ? '' : 'truncate'}`}>
                                            ...
                                            >
                                                {suggestions.length > 0 ? (
                                                    suggestions.slice(0, 3).map((task, idx) => {
                                                        ...
                                                        const priority =
                                                            typeof task === 'object' ? task.priority : 'medium';

                                                        return (
                                                            <div
                                                                key={idx}
                                                                className="flex items-start gap-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors border border-white/5 group/item"
                                                            >
                                                                <div
                                                                    className={`mt-0.5 w-1.5 h-1.5 rounded-full flex-shrink-0 ${priority === 'high' ? 'bg-red-400' : 'bg-purple-400'}`}
                                                                />
                                                                ...
                                                                <button
                                                                    onClick={() =>
                                                                        onCopySuggestion && onCopySuggestion(taskText)
                                                                    }
                                                    ...
                                                    <div className="text-center py-8">
                                                        ...
                                                        <p className="text-slate-400 text-xs">
                                                            No immediate actions found. Good job!
                                                        </p>
                                                    </div>
                                                )}
                                            </motion.div>
                                            ...
                                            >
                                                {vulnerabilities.length === 0 && hotspots.length === 0 ? (
                                                    <div className="text-center py-8">
                                                        ...
                                                        <p className="text-slate-400 text-xs">
                                                            No critical issues detected. Secure & Clean!
                                                        </p>
                                                    </div>
                                                ) : (
                                                    <>
                                                                    ...
                                                                    >
                                                                        <div className="flex justify-between items-start mb-1">
                                                                            <span className="text-xs font-bold text-red-300">
                                                                                {formatIssueItem(vuln.issue)}
                                                                            </span>
                                                                            <span className="text-[9px] px-1.5 py-0.5 rounded bg-red-500/20 text-red-300 uppercase font-bold">
                                                                                {vuln.severity || 'High'}
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    {hotspots.slice(0, 3).map((hotspot, idx) => (
                                                                        <div key={idx} className="space-y-1">
                                                                            <div className="flex justify-between items-center text-xs">
                                                                                <span
                                                                                    className="font-medium text-slate-300 truncate max-w-[200px]"
                                                                                    title={hotspot.file}
                                                                                >
                                                                                    {hotspot.file}
                                                                                </span>
                                                                                <span
                                                                                    className={`font-bold ${hotspot.complexityScore >= 8 ? 'text-red-400' : 'text-orange-400'}`}
                                                                                >
                                                                            ...
                                                                            <div className="w-full bg-white/5 rounded-full h-1 overflow-hidden">
                                                                                <div
                                                                                    ...
                                                                                    style={{
                                                                                        width: `${(hotspot.complexityScore / 10) * 100}%`,
                                                                                    }}
                                                                                />
                                                                            </div>
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4 p-3 rounded-xl bg-white/5 border border-white/5">
                                <div className="flex flex-wrap gap-4 md:gap-6 text-[11px]">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-white font-medium flex items-center gap-1">
                                            <FileText size={12} className="text-blue-400" /> {project.commits || 0}
                                        </span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-slate-500 uppercase text-[9px] tracking-tight mb-0.5">
                                        ...
                                        <span className="text-white font-medium flex items-center gap-1 group/stat relative">
                                            {project.githubData?.trafficRestricted ? (
                                                <button
                                                    ...
                                                    className="flex items-center gap-1 opacity-60 hover:opacity-100 transition-opacity cursor-pointer"
                                                    title="Click to upgrade GitHub scopes to view traffic stats"
                                                >
                                                    <Lock size={10} className="text-yellow-500" />
                                                    <span className="text-slate-500 hover:text-yellow-500 transition-colors">
                                                        Locked
                                                    </span>
                                                </button>
                                            ) : (
                                                <>
                                                    ...
                                                    {project.githubData?.allTimeClones ||
                                                        project.githubData?.clones ||
                                                        0}
                                                </>
                                            )}
                                        </span>
                            ...
                            {isDesktop && (
                                ...
                                >
                                    <div
                                        ...
                                        className="max-h-[70vh] overflow-y-auto overflow-x-hidden pr-2 custom-scrollbar"
                                    >
                                        {detailContent}
                                    </div>
                                </Modal>
...
function ProjectForm({ formData, setFormData, onSubmit, onCancel, isEdit, analyzing, error, onRequiresAuth }) {
    ...
    if (hasRepo === 'no' && !createRepoMode && !formData.repositoryUrl) {
        return (
            <div className="space-y-5">
                ...
                {repoError && <p className="text-red-400 text-sm bg-red-500/10 p-3 rounded-lg">{repoError}</p>}
            ...
            let result = {
                ...
                githubData: {
                    ...
                    openIssues:
                        ...
                        (Array.isArray(repoInfo.openIssues) ? repoInfo.openIssues.length : 0),
        ...
        try {
            ...
            if (newProject) {
                ...
                setStats((prev) => ({
                    ...
                    activeProjects:
                        projectData.status === 'Active' ? (prev.activeProjects || 0) + 1 : prev.activeProjects || 0,
                }));
    ...
    return (
        <PixelTransition loading={false}>
            <motion.div>
                            ...
                            {!loading && projects.length === 0 && !error && (
                                ...
                                >
                                    ...
                                    <p className="text-slate-400 mb-6 max-w-md mx-auto text-xs md:text-base px-4 md:px-0">
                                        Track your coding projects, link your GitHub repos, and let AI analyze your
                                        progress!
                                    </p>
                        ...
                        [
                            ...new Set(
                                projects
                                    ...
                                    .concat(projects.map((p) => p.primaryLanguage).filter(Boolean))
                            ),
                        ].slice(0, 3)
                    }
                />
                ...
                {/* Saved Repos Modal */}
                <SavedProjectsModal isOpen={showSavedModal} onClose={() => setShowSavedModal(false)} />
                ...
                <GitHubPermissionModal isOpen={showGitHubModal} onClose={() => setShowGitHubModal(false)} />
                        ...
                        <div className="relative">
                            ...
                            <div className="relative p-4 rounded-xl bg-white/5 border border-white/10">
                                <p className="text-slate-300 text-sm leading-relaxed">
                                    Get <span className="text-emerald-400 font-medium">personalized project ideas</span>{' '}
                                    based on your skills, learning history, and current tech stack.
                                </p>
                            </div>
                        </div>
                                ...
                                {[
                                    {
                                        ...
                                        desc: '1-2 weeks',
                                        activeClass:
                                            'bg-emerald-500/20 border-emerald-500 shadow-lg shadow-emerald-500/20 text-white',
                                    ...
                                    },
                                    {
                                        ...
                                        desc: '2-4 weeks',
                                        activeClass:
                                            'bg-purple-500/20 border-purple-500 shadow-lg shadow-purple-500/20 text-white',
                                    ...
                                    },
                                    {
                                        ...
                                        desc: '4-8 weeks',
                                        activeClass:
                                            'bg-orange-500/20 border-orange-500 shadow-lg shadow-orange-500/20 text-white',
                                    ...
                                    <button
                                        ...
                                        className={`p-2 sm:p-4 rounded-xl border-2 transition-all duration-300 text-center group relative overflow-hidden flex flex-col items-center justify-center ${
                                    ...
                                    >
                                        ...
                                        <div className="relative w-full">
                                            ...
                                            <div className="text-[10px] sm:text-sm font-semibold mb-0.5 sm:mb-1">
                                                {diff.label}
                                            </div>
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start justify-between gap-3 mb-3">
                                                ...
                                                <div className="flex items-center gap-2 flex-shrink-0">
                                                    ...
                                                    >
                                                        <Bookmark
                                                            className={`w-4 h-4 ${savedIdeaTitles.has(idea.title) ? 'fill-teal-400' : ''}`}
                                                        />
                                                    </button>
                                            ...
                                            <div className="flex items-center gap-4 text-xs text-slate-500 mb-4 p-3 rounded-xl bg-white/5 overflow-hidden">
                                                ...
                                                <span className="flex items-center gap-1.5 flex-1 min-w-0 overflow-hidden">
                                                    ...
                                                    <span className="text-slate-400 truncate">
                                                        {(idea.newSkillsToLearn || []).slice(0, 2).join(', ') ||
                                                            'New skills await'}
                                                    </span>
                                                </span>
                                            </div>
                                                ...
                                                <Button
                                                    onClick={async () => {
                                                        ...
                                                        try {
                                                            ...
                                                            alert(
                                                                'Prompt copied to clipboard! Paste it in Gemini to get your roadmap.'
                                                            );
                        ...
                        {!generatingIdeas && projectIdeas.length === 0 && (
                            <div className="text-center py-12">
                                ...
                                <p className="text-slate-600 text-xs">
                                    Click "Generate" to get AI-powered project recommendations
                                </p>
                            </div>
                        )}
                    </div>
