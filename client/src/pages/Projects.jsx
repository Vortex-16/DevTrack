        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <StatCard icon={<Folder className="w-6 h-6" />} label="Total Projects" value={stats.totalProjects || 0} color="purple" delay={0.1} />
                    <StatCard icon={<Activity className="w-6 h-6" />} label="Active" value={stats.activeProjects || 0} color="cyan" delay={0.15} />
                    <StatCard icon={<CheckCircle className="w-6 h-6" />} label="Completed" value={stats.completedProjects || 0} color="green" delay={0.2} />
                    <StatCard icon={<GitCommitHorizontal className="w-6 h-6" />} label="Total Commits" value={stats.totalCommits || 0} color="orange" delay={0.25} />
                </div>
