...
export default function TimePicker({ value, onChange, label, minTime }) {
    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            >
                <span className={value ? 'text-white' : 'text-slate-500'}>{formatDisplay()}</span>
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <div className="text-xs font-semibold text-slate-500 mb-2 text-center uppercase tracking-wider">
                                Hour
                            </div>
                            <ReactLenis
                                root={false}
                            ...
                            >
                                {hours.map((h) => {
                                    const isValid =
                                        isTimeValid(h, '00', selectedPeriod) || isTimeValid(h, '55', selectedPeriod); // Check if any minute in this hour is valid
                                    return (
                                        <button
                                            key={h}
                                            type="button"
