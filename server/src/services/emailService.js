...
class EmailService {
    ...
    async sendWeeklyReport(to, userName, pdfBuffer, aiSummary = '') {
        ...
        const aiSection = aiSummary
            ? `
            <div style="background: #111111; border-left: 4px solid #e8a838; padding: 20px; margin: 24px 0; border-radius: 8px;">
                <h3 style="color: #e8a838; margin-top: 0; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em; font-weight: 800;">✨ AI Weekly Insight</h3>
                <p style="color: #bbbbbb; margin-bottom: 0; font-style: italic; line-height: 1.6;">"${aiSummary}"</p>
            </div>
        `
            : '';
            ...
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #1a1a1a; border-radius: 16px; overflow: hidden;">
                <div style="padding: 32px 28px 24px 28px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <div style="background: #4dd0e1; color: #1a1a1a; font-weight: 800; padding: 8px 18px; border-radius: 6px; display: inline-block; font-size: 11px; letter-spacing: 0.08em; text-transform: uppercase;">📊 Weekly Analytics</div>
                    </div>
                    
                    <h1 style="color: #ffffff; font-size: 24px; font-weight: 800; margin: 0 0 8px 0; text-align: center;">Weekly DevTrack Report</h1>
                    <p style="color: #cccccc; font-size: 15px; line-height: 1.7; text-align: center; margin: 0 0 28px 0;">Hi ${userName},</p>
                    
                    <div style="background: #222222; border: 1px solid #4dd0e1; border-radius: 10px; padding: 18px 20px; margin-bottom: 12px; text-align: center;">
                        <p style="color: #bbbbbb; font-size: 14px; line-height: 1.6; margin: 0;">
                            Your weekly GitHub activity report has been compiled and is <strong style="color: #4dd0e1;">attached as a PDF</strong>.
                        </p>
                    </div>
                    
                    ${aiSection}
                    
                    <p style="color: #ffffff; font-size: 16px; font-weight: 800; text-align: center; margin: 32px 0 24px 0;">
    ...
    async sendCommentNotification(to, projectName, commenterName, commentContent) {
        ...
        const html = `
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #1a1a1a; border-radius: 16px; overflow: hidden;">
                <div style="padding: 32px 28px 24px 28px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <div style="background: #e8a838; color: #1a1a1a; font-weight: 800; padding: 8px 18px; border-radius: 6px; display: inline-block; font-size: 11px; letter-spacing: 0.08em; text-transform: uppercase;">💬 Showcase Interaction</div>
                    </div>
                    
                    <h2 style="color: #ffffff; font-size: 20px; font-weight: 800; text-align: center; margin-bottom: 16px;">New Comment on Your Project</h2>
                    <p style="color: #cccccc; font-size: 15px; text-align: center; margin-bottom: 24px;">
                        <strong style="color: #4dd0e1;">${commenterName}</strong> commented on <strong>"${projectName}"</strong>:
                    </p>
                    
                    <blockquote style="background: #111111; border-left: 4px solid #4dd0e1; padding: 16px 20px; margin: 16px 0; border-radius: 0 8px 8px 0;">
                        <p style="color: #bbbbbb; margin: 0; line-height: 1.6;">${commentContent}</p>
                    </blockquote>
                    
                    <div style="text-align: center; margin-top: 32px;">
                        <a href="https://devtrackweb.xyz/showcase" style="background: #4dd0e1; color: #1a1a1a; text-decoration: none; padding: 12px 32px; border-radius: 8px; font-weight: 800; font-size: 14px; display: inline-block; box-shadow: 0 4px 20px rgba(77, 208, 225, 0.3);">
                            View on DevTrack →
                        </a>
                    </div>
                </div>
                ...
                <div style="border-top: 1px solid #333333; padding: 24px 28px; text-align: center;">
                    <p style="color: #777777; font-size: 12px; margin: 0 0 6px 0;">DevTrack • Community Showcase</p>
                </div>
            </div>
        `;
